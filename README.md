...
- you will need minimum 50G of free disc space in one partition, here we assume you will use **_/data_** as the installation dir
...
This command should **_not_** return anything:
...
(typically **_/etc/hosts_**) (replace domain-name with the domain name of the machine):
...
We will install everything under the same directory on the server, in this README we will use **_/data_** for this.
...
## you see **_NetworkError when attempting to fetch resource._**
